...
\subsection{Data Intensive Test}
...
Test $A$ & 10,000            & 1-10        			& 5           & 100.000      \\
Test $B$ & 1.000.000-10.000.000			   & 7          			& 5           & 100.000
\end{tabular}
\end{table}
...
The synchronization intensive test will consists of the two individual tests: test $C$ and test $D$. These test are created to investigate how the  concurrency models affect a concurrent computation with a high degree of synchronization.

Test $C$ is based on a fixed size data set, while the number of mapper tasks will be scaled up. The goal is to determine how the selected concurrency models scale as more concurrent tasks are added. The test will be based on a data set of 10,000 vectors. Five clusters will be created, using a 1 to 10 mapper tasks. The algorithm will run for 100,000 iterations. The amount of mappers, have been chosen with consideration to the amount of physical and logical cores in hardware used for the test, described further in \bsref{subsec:hardware}. Our implementation uses one thread to coordinate and drive the calculations. Consequently, making 3 mapper tasks will utilise 4 cores concurrently.
...
1                   &     57294      &      57388      &    57343  &  1.00   & 1.00 &    1.00    \\
2                   &     29625      &      29749      &    29660  &  1.00   & 1.00 &    1.00    \\
3                   &     24969      &      25068      &    24970  &  1.00   & 1.00 &    1.00    \\
4                   &     19290      &      19319      &    19378  &  1.00   & 1.00 &    1.00    \\
5                   &     17823      &      17890      &    17897  &  1.00   & 1.00 &    1.00    \\
6                   &     15611      &      15506      &    15512  &  1.01   & 1.00 &    1.00    \\
7                   &     13930      &      13919      &    13773  &  1.01   & 1.01 &    1.00    \\
8                   &     12637      &      12599      &    12617  &  1.00   & 1.00 &    1.00    \\
\end{tabular}
