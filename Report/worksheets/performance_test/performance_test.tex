...
Clojure was selected for the \ac{STM} based implementation because of its native support for \ac{STM}. As described in BLA\andreas{Find reference}, the native support enables compiler and runtime optimisations, which potentially is a big factor in regards to performance. 
