...
Formuler formål med preliminary investigation\\
Skriv at der kommer en detaljeret gennemgang og sammenligning senere\\
Forsøg at præsentere de forskellige modeller isoleret\\
Hvad er current state of the art, related work, open problem?\\
Hvordan har vi valgt de modeller vi vil undersøge?

This chapter presents a preliminary investigation of different concurrency models. As it is not possible to go in depth with all concurrency models this chapter serves the purpose of giving an overview of these models\lone{Lyder som en dårlig undskyldning}. Based on this overview we will select which models to focus on in the project\lone{Definer the project}. \toby{Bud på en intro, i er velkommen til at ændre eller lave ny.} The first model to be investigated will be the traditional \ac{TL}.
