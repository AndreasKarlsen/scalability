...
Based on the above considerations we argue that the actor model has a high level of abstraction, as illustrated on \bsref{fig:actor_level_of_abstraction}.
