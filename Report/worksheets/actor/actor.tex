...
\andreas[inline]{Jeg savner subsections}
...
\subsection{Semantic Properties}\toby[inline]{Does this work with having some of the properties explain already? I don't like to explain them again and not sure i can get all down here without something is missing further up}\andreas[inline]{I think you can categorize it into the most essential properties (explained first), and a more detailed view (explained here). Just tell that to the reader}
...
%8.13 Limitations of the Actor-Based Model i JVM Mastering syncrhonization
