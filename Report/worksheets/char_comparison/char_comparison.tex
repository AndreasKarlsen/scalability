...
\subsection{Low or High Simplicity}
...
\subsection{Low or High Orthogonality}
...
\subsection{Low or High Readability}\label{sec:result_char_readability}
...
\subsection{Low or High Level of Abstraction}
...
\subsection{Low or High Expressivity}
...
%Good alternative to locks, especially if transactions performance is not the top priority and programmers are familar with the shared memory concurrency and critical regions
