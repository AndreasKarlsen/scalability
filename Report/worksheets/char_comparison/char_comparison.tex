...
This chapter presents a comparison of the selected concurrency models and their characteristics. The comparison will be used in \bsref{chap:choosing_con_model} to assist in guiding when to apply each of the selected concurrency models.
\label{chap:results}
...
native method calls which result in the placement on the spectrum between middle and high orthogonality.
