...
Based on the considerations presented here we give the definition of concurrency shown in \bsref{def:concurrency}, followed by the definition of concurrency presented in \bsref{def:parallelism}.
