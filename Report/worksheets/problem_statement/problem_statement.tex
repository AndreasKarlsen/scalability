...
%
In order to structure our investigation, we have extracted five\toby{Make sure this is the right number in the end} questions. The questions are based on problems found in our preliminary investigation, which is described in the \bsref{chap:introduction}. These questions will serve as a guideline our further investigation, and will be used to conclude upon the project in \bsref{chap:conclusion}.
