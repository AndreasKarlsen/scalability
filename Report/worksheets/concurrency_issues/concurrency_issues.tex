...
This chapter presents an overview of known\lone{hvor? research community? de første 5 papirer?} issues related to concurrency. Some of the issues are related mainly to shared memory concurrency while others apply to a broader spectrum, including asynchronous message passing.
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=0.95\textwidth]{\rootpath/worksheets/concurrency_issues/figures/pi_graf} 
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=0.95\textwidth]{\rootpath/worksheets/concurrency_issues/figures/pi_graf2} 
 \caption{Priority inversion example}
